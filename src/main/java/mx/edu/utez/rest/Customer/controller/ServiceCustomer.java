package mx.edu.utez.rest.Customer.controller;

import mx.edu.utez.rest.Customer.model.Customer;
import mx.edu.utez.rest.Customer.model.DaoCustomer;
...
public class ServiceCustomer {
    ...
    @Consumes("application/x-www-form-urlencoded")
    public Customer save(int customerNumber, MultivaluedMap<String, String> formParams){
